 ...
 */
public class CaffeLatteBaristaDrink extends BaristaDrink {
     ...
     * Constructor
     */
    public CaffeLatteBaristaDrink() {       
        inventory = super.getSingleBaristaInventory();   
        drinkMenu = super.getSingleBaristaDrinkMenu();
    }
    
    /**
     * This method creates a unique identity and recipe for a Caffe Latte drink.
     */
    @Override
    public void initBaristaDrink() {
        this.setName(LATTE);
        
        // create a unique (one-of-a-kind) recipe for "Caffe Latte"
