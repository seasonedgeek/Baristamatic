 ...
 */
public class CaffeMochaBaristaDrink extends BaristaDrink {
     ...
     * Constructor
     */
    public CaffeMochaBaristaDrink() {        
        inventory = super.getSingleBaristaInventory();
        drinkMenu = super.getSingleBaristaDrinkMenu();
    }
    
    /**
     * This method creates a unique identity and recipe for a Caffe Mocha drink.
     */
    @Override
    public void initBaristaDrink() {
        this.setName(MOCHA);
        
        // create a unique (one-of-a-kind) recipe for "Caffe Mocha"
