 ...
 */
public class CoffeeBaristaDrink extends BaristaDrink {
     ...
     * Constructor
     */
    public CoffeeBaristaDrink() {               
        inventory = super.getSingleBaristaInventory();        
        drinkMenu = super.getSingleBaristaDrinkMenu();
    }
    
    /**
     * This method creates a unique identity and recipe for a Coffee drink.
     */
    @Override
    public void initBaristaDrink() {
        this.setName(COFFEE);
        
        // create a unique (one-of-a-kind) recipe for "Coffee"
